...
<head>
    ...
    <title>Formulir Pendaftaran Data Kandidat</title>
...
<body class="bg-gray-100">
    <div class="p-8">
        <div class="max-w-4xl mx-auto bg-white p-8 shadow-lg rounded-lg">
            <div class="flex mb-10 flex-wrap justify-between">
                <img src="logo.png" alt="Logo" class="mx-auto rounded-xl shadow-lg mb-4 w-32 h-auto"> <!-- Tempat logo -->
                <h1 class="text-3xl font-bold text-center text-gray-800">Form Pendaftaran Kandidat LPK Japan Educational Cooperation Association Serang Banten Indonesia</h1>
            </div>
            <form id="kandidatForm" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div>
                    <label class="block font-medium text-gray-700">Jenis Kandidat</label>
                    <select name="jenis_kandidat" required class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                        <option value="internal">Internal</option>
                        <option value="eksternal">Eksternal</option>
                    </select>
                    <label class="text-gray-400 font-serif text-sm">*Isikan Internal jika Anda berasal dari LPK Japan Educational Cooperation Association, isikan Eksternal jika bukan.</label>
                </div>
                ...
                <!-- Riwayat Pekerjaan -->
                <h3 class="text-xl font-bold mb-2">Pengalaman Kerja</h3>
                ...
                <div id="riwayatPekerjaanContainer">
                    ...
                    <h1 class="text-sm text-gray-600 mb-3">*Maksimal 5 Pekerjaan. Lewati jika Anda tidak ingin menginput bagian ini</h1>
                </div>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <label class="block font-medium text-gray-700">SSW/SENMONKYU/3KYUU/HYOUKACHOSO (pdf)</label>
                    ...
                    <div>
                        <label class="block font-medium text-gray-700">Sertifikat Magang (pdf)</label>
                    ...
                    <div>
                        <label class="block font-medium text-gray-700">Paspor (pdf)</label>
                    ...
                    <div>
                        <label class="block font-medium text-gray-700">JLPT/JFT (pdf)</label>
                ...
                <h1 class="text-sm text-red-600 mb-3">*Pastikan Anda sudah mengisi form dengan sesuai sebelum submit.</h1>
                <!-- Tombol Submit -->
    ...
    <script>
        ...
        form.addEventListener('submit', async (e) => {
            ...
            try {
                const response = await fetch('http://localhost/candidate-management-jeca/api/internal/add_kandidat_public_api.php', {
                    method: 'POST',
                    body: formData
                });
