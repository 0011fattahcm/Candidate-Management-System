...
<body class="bg-gray-100">
    <div class="ml-64 p-8">
        ...
        <div class="flex items-center justify-between">
            <h1 class="text-3xl font-bold text-gray-800">Kandidat Internal</h1>
            <a href="../internal/add_kandidat_internal.php"
        ...
        <!-- nen tahun -->
        <!-- form export ke excel -->
        <form action="../../export_internal_excel.php" method="GET" class="space-y-4 mt-5 bg-gray-200 p-4 rounded-md shadow-sm">
            <!-- Rentang Tanggal -->
            ...
            <table class="w-full table-auto border-collapse">
                <thead>
                    <tr class="bg-gray-200 text-left text-gray-600 uppercase text-sm leading-normal">
                        ...
                        <th class="py-3 px-6">Tanggal Pendaftaran</th>
    ...
    <script>
        ...
        function fetchKandidat(page = 1) {
            $.ajax({
                url: '../../api/internal/internal_list_api.php',
                type: 'GET',
                data: {
                    page: page
                },
                    ...
                    response.data.forEach(function(kandidat) {
                        kandidatHTML += `
                            <tr class="border-b hover:bg-gray-100">
                                ...
                                <td class="py-3 px-6">
                                    <a href="see_kandidat_internal.php?id=${kandidat.id}" class="text-blue-500 hover:underline">Lihat</a> |
                                    <a href="edit_kandidat_internal.php?id=${kandidat.id}" class="text-green-500 hover:underline">Edit</a> |
