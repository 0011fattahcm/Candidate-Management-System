...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $conn->prepare($query);
    $stmt->bind_param(
        'sssssssddsssssssssssssssssssssi',
        $pas_foto,
        $nama_lengkap,
        $nama_ayah,
        $nama_ibu,
    ...
    if ($stmt->execute()) {
        echo "<script>alert('Data kandidat berhasil diperbarui!'); window.location.href = 'internal_list.php';</script>";
    } else {
...
<head>
    ...
    <title>Edit Kandidat Internal</title>
