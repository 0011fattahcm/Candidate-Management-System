...
<body class="bg-gray-100">
    <div class="ml-64 p-8">
        <div class="max-w-4xl mx-auto bg-white p-8 shadow-lg rounded-lg">
            <div class="flex mb-5 flex-wrap justify-between">
                <h1 class="text-3xl font-bold text-gray-800">Form Input Kandidat Internal</h1>
            ...
            <form id="kandidatForm" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="file" name="sertifikat_magang" accept=".pdf, .docx, .xlsx" required class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                    </div>
                    <div>
                        <label class="block font-medium text-gray-700">Paspor (pdf, docx, xlsx)</label>
                        <input type="file" name="paspor" accept=".pdf, .docx, .xlsx" required class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                    </div>
                    <div>
    ...
    <script>
        ...
        form.addEventListener('submit', async (e) => {
            ...
            try {
                const response = await fetch('http://localhost/candidate-management-jeca/api/internal/add_kandidat_api.php', {
                    method: 'POST',
                    body: formData
                });
                ...
                if (result.status === 'success') {
                    ...
                    form.reset();
                    setTimeout(() => {
                        window.location.href = 'internal_list.php';
                    }, 2000);
                } else {
